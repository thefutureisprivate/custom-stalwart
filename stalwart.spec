...
%changelog
* Sun Aug 16 2026 ParticleOS <contact@thefutureisprivate.dev> - 0.16.17-22
- Permit status checks for the verified transient RootImage probe
- Keep systemd's read-only image fallback probe denied without audit noise
